...
public class AlunoModalidadeTableModel extends AbstractTableModel {
    ...
    private List<AlunoHasModalidades> dados;
    private final SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
    //private final SimpleDateFormat timeformat = new SimpleDateFormat("h:mm a");
  

    public AlunoModalidadeTableModel(List<AlunoHasModalidades> dados) {
        this.dados = dados;
    }

    public void setDados(List<AlunoHasModalidades> dados) {
        this.dados = dados;
    }

    public List<AlunoHasModalidades> getDados() {
        return this.dados;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                return s.getAlunoHasModalidadesPK().getAlunoCpf();
            case 1:
                return s.getAlunoHasModalidadesPK().getModalidadesIdModalidades();            
            default:
...
//    }
    ...
    public AlunoHasModalidades getValue(int rowIndex) {
